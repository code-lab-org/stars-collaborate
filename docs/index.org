...
# https://github.com/ryananan/collaborate
# https://ryananan.github.io/collaborate
#+ATTR_HTML: :width 100%
#+ATTR_MD: :width 300
...
** Source Code & Documentation
   The complete source code is available on [[https://github.com/ryananan/collaborate][Github]].  Complete Doxygen API
   documentation is available for the [[https://ryananan.github.io/collaborate/cpp_html/index.html][C++ Library]] and [[https://ryananan.github.io/collaborate/py_html/index.html][Python Tools]]. There is
   also a [[https://ryananan.github.io/collaborate/refman.pdf][User Manual]].
** Applications
...
** Publications
   ...
   OH.  [[[https://ryananan.github.io/collaborate/publications/count_abstract.pdf][Abstract]]|[[https://ryananan.github.io/collaborate/publications/count_poster.pdf][Poster]]]
   #+END_QUOTE
   #+BEGIN_QUOTE
   ...
   2019, Cleveland, OH.  [[[https://ryananan.github.io/collaborate/publications/ccaaw_paper.pdf][Paper]]|[[https://ryananan.github.io/collaborate/publications/ccaaw_slides.pdf][Slides]]]
   #+END_QUOTE
   #+BEGIN_QUOTE
   ...
   Yokahama, Japan.  [[[https://ryananan.github.io/collaborate/publications/igarss_paper.pdf][Paper]]|[[https://ryananan.github.io/collaborate/publications/igarss_slides.pdf][Slides]]]
   #+END_QUOTE
   #+BEGIN_QUOTE
   Ryan Linnabary, et. al., /"Open Source Software for Simulating Collaborative
   ...
   2019, Columbus, OH.  [[[https://ryananan.github.io/collaborate/publications/cerf_slide.pdf][Slide]]|[[https://ryananan.github.io/collaborate/publications/cerf_poster.pdf][Poster]]]
   #+END_QUOTE
   -----
* Work Flow
...
** Option 1: Docker
   ...
   ~ $ git clone https://github.com/ryananan/collaborate.git
   #+END_SRC
   Install Docker.
   #+BEGIN_SRC
   ~ $ sudo apt install docker.io
   #+END_SRC
   Build the Docker image using the [[https://raw.githubusercontent.com/ryananan/collaborate/master/env/docker/build.sh][image build script]].
   #+BEGIN_SRC
   ~ $ sudo ./collaborate/env/docker/build.sh
   #+END_SRC
   Run the Docker container using the [[https://raw.githubusercontent.com/ryananan/collaborate/master/env/docker/run.sh][container run script]].
   #+BEGIN_SRC
...
*** Dependencies
    ...
    ~ $ git clone https://github.com/ryananan/collaborate.git
    #+END_SRC
    Download C++ dependencies listed in [[https://raw.githubusercontent.com/ryananan/collaborate/master/env/local/apt.txt][apt.txt]].
    #+BEGIN_SRC
    ~ $ cat collaborate/env/local/apt.txt | xargs sudo apt install -y
    #+END_SRC
    Download Python3 dependencies listed in [[https://raw.githubusercontent.com/ryananan/collaborate/master/env/local/py.txt][py.txt]].
    #+BEGIN_SRC
...
* Build the Project
  /Time/: 5 min.
  #
  The following [[https://raw.githubusercontent.com/ryananan/collaborate/master/sys/build.sh][project build script]] will build the project with CMake.  If you
  ...
  The [[https://raw.githubusercontent.com/ryananan/collaborate/master/sys/clean.sh][clean script]] accomplishes this, but /does not prompt for confirmation/.
  #+BEGIN_SRC
...
* Condition the Input Data
  ...
  broken-up into smaller files.  Run the [[https://raw.githubusercontent.com/ryananan/collaborate/master/util/combine.py][combine script]] to merge these files
...
* Simple Example
  /Time/: 2 min.
  #
  The simple simulation /(source: [[https://raw.githubusercontent.com/ryananan/collaborate/master/apps/simple/simple.cpp][simple.cpp]])/ will produce simulation data in
  the ~output~ folder.
  #+BEGIN_SRC
  ...
  #
  Run the [[https://raw.githubusercontent.com/ryananan/collaborate/master/util/plot_antenna.py][antenna plot script]] to view the dipole's gain pattern (passing ~-f~
  ...
  #
  Run the [[https://raw.githubusercontent.com/ryananan/collaborate/master/util/plot_series.py][series plot script]] to graph satellite parameters in time.
  #+BEGIN_SRC
...
* Intermediate Example
  ...
  ~/collaborate $ ./sys/clean.sh
  #+END_SRC
  The intermediate simulation /(source: [[https://raw.githubusercontent.com/ryananan/collaborate/master/apps/intermediate/intermediate.cpp][intermediate.cpp]])/ will produce
  ...
  #+END_SRC
  #
  Run the [[https://raw.githubusercontent.com/ryananan/collaborate/master/util/plot_map.py][map plot script]] to view the initial positions of the satellites
  ...
  [[https://raw.githubusercontent.com/ryananan/collaborate/master/util/plot_network.py][network plot script]].
  #+BEGIN_SRC
  ...
  #
  Use the [[https://raw.githubusercontent.com/ryananan/collaborate/master/util/animate_network.py][network animation script]] to visualize instantaneous line-of-sight
  distances.
  #+BEGIN_SRC
  ...
  #+HTML: </video>
  #
  Run the [[https://raw.githubusercontent.com/ryananan/collaborate/master/util/animate_map.py][map animation script]] to visualize satellite motion.  This works best
  ...
  #
  Run the [[https://raw.githubusercontent.com/ryananan/collaborate/master/util/plot_data.py][data plot script]] with an additional argument to view the first frame
...
* Advanced Example
  ...
  ~/collaborate $ ./sys/clean.sh
  #+END_SRC
  The advanced simulation /(source: [[https://raw.githubusercontent.com/ryananan/collaborate/master/apps/advanced/advanced.cpp][advanced.cpp]])/ will produce simulation data
  ...
  tree_3_165_5359.tex
  #+END_SRC
  Run the [[https://raw.githubusercontent.com/ryananan/collaborate/master/util/plot_measurement.py][measurement plot script]] to plot a map and graph of a measurement.
  ...
  [[https://raw.githubusercontent.com/ryananan/collaborate/master/util/plot_channel.py][channel plot script]].
  #+BEGIN_SRC
...
* Library Details
** License
   This project is licensed under [[https://raw.githubusercontent.com/ryananan/collaborate/master/LICENSE.txt][LGPL v3.0]] and contains code protected by other
   ...
   |------------------+------------+------------+-------------+----------------+----------------------|
   | libs/collaborate | C++        | [[https://raw.githubusercontent.com/ryananan/collaborate/master/LICENSE.txt][LGPL v3.0]]  | [[https://raw.githubusercontent.com/ryananan/collaborate/master/COPYRIGHT.txt][Link]]        | Ryan Linnabary | [[https://github.com/ryananan/collaborate][ryananan/collaborate]] |
   |------------------+------------+------------+-------------+----------------+----------------------|
   | libs/sgp4        | C++        | [[https://raw.githubusercontent.com/ryananan/collaborate/master/libs/sgp4/LICENSE.txt][Apache 2.0]] | [[https://raw.githubusercontent.com/ryananan/collaborate/master/libs/sgp4/COPYRIGHT.txt][Link]]        | Daniel Warner  | [[https://github.com/dnwrnr/sgp4][dnwrnr/sgp4]]          |
   |------------------+------------+------------+-------------+----------------+----------------------|
   | libs/spdlog      | C++        | [[https://raw.githubusercontent.com/ryananan/collaborate/master/libs/spdlog/LICENSE.txt][MIT]]        | [[https://raw.githubusercontent.com/ryananan/collaborate/master/libs/spdlog/COPYRIGHT.txt][Link]]        | Gabi Melman    | [[https://github.com/gabime/spdlog][gabime/spdlog]]        |
   |------------------+------------+------------+-------------+----------------+----------------------|
   | libs/nlohmann    | C++        | [[https://raw.githubusercontent.com/ryananan/collaborate/master/libs/nlohmann/LICENSE.txt][MIT]]        | [[https://raw.githubusercontent.com/ryananan/collaborate/master/libs/nlohmann/COPYRIGHT.txt][Link]]        | Niels Lohmann  | [[https://github.com/nlohmann/json][nlohmann/json]]        |
   |------------------+------------+------------+-------------+----------------+----------------------|
   | libs/netcdf      | C++        | [[https://raw.githubusercontent.com/ryananan/collaborate/master/libs/netcdf/LICENSE.txt][UniData]]    | [[https://raw.githubusercontent.com/ryananan/collaborate/master/libs/netcdf/COPYRIGHT.txt][Link]]        | Unidata        | [[https://github.com/Unidata/netCDF-cxx4][unidata/netcdf-cxx4]]  |
   |------------------+------------+------------+-------------+----------------+----------------------|
   | util             | Python     | [[https://raw.githubusercontent.com/ryananan/collaborate/master/LICENSE.txt][LGPL v3.0]]  | [[https://raw.githubusercontent.com/ryananan/collaborate/master/COPYRIGHT.txt][Link]]        | Ryan Linnabary | [[https://github.com/ryananan/collaborate][ryananan/collaborate]] |
   |------------------+------------+------------+-------------+----------------+----------------------|
** Structure
...
** Profiling
   The call-graph below was created with Valgrind /(source: [[https://raw.githubusercontent.com/ryananan/collaborate/master/sys/profile.sh][profile.sh]])/.  It
   shows the most common function calls (>5% CPU) for the program
   [[https://raw.githubusercontent.com/ryananan/collaborate/master/apps/simple/simple.cpp][simple.cpp]].
   #+BEGIN_SRC
...
*** Simple Example
    Testing memory behavior for [[https://raw.githubusercontent.com/ryananan/collaborate/master/apps/simple/simple.cpp][simple.cpp]]:
    #+BEGIN_SRC
    ...
    #+END_SRC
*** Intermediate Example
    Testing memory behavior for [[https://raw.githubusercontent.com/ryananan/collaborate/master/apps/intermediate/intermediate.cpp][intermediate.cpp]]:
    #+BEGIN_SRC
    ...
    #+END_SRC
*** Advanced Example
    Testing memory behavior for [[https://raw.githubusercontent.com/ryananan/collaborate/master/apps/advanced/advanced.cpp][advanced.cpp]]:
    #+BEGIN_SRC
