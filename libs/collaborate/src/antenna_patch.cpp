...
AntennaPatch::AntennaPatch(const double& _max_gain_db,
...
double AntennaPatch::GainDb(const double& _theta_rad,
  ...
  if (_theta_rad < util::kPiByTwoRad) {
    directional_gain_db_ = kMaxGainDb_ * std::cos(_theta_rad);
  }
