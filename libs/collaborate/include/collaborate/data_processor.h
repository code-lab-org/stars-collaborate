...
#ifndef LIBS_COLLABORATE_INCLUDE_COLLABORATE_DATA_PROCESSOR_H_
#define LIBS_COLLABORATE_INCLUDE_COLLABORATE_DATA_PROCESSOR_H_
...
/// @class DataProcessor
/// @brief A satellite's internal data processor
class DataProcessor {
 public:
  /// @brief Constructor
  DataProcessor();
  ...
  virtual void Compute(
      ...
      std::vector<std::pair<bool, uint16_t>>* _feedback) const = 0;
  ...
  virtual void Regression(const bool& _success,
...
#endif  // LIBS_COLLABORATE_INCLUDE_COLLABORATE_DATA_PROCESSOR_H_
