...
#ifndef LIBS_COLLABORATE_INCLUDE_COLLABORATE_DATA_PROCESSOR_TEMPLATE_H_
#define LIBS_COLLABORATE_INCLUDE_COLLABORATE_DATA_PROCESSOR_TEMPLATE_H_
...
/// @brief A template satellite's internal data processor
class DataProcessorTemplate : public DataProcessor {
 public:
  /// @brief Constructor
  ...
  /// @param[in] _max_list List of minimal suggestions
...
#endif  // LIBS_COLLABORATE_INCLUDE_COLLABORATE_DATA_PROCESSOR_TEMPLATE_H_
