...
#ifndef LIBS_COLLABORATE_INCLUDE_COLLABORATE_ANTENNA_PATCH_H_
#define LIBS_COLLABORATE_INCLUDE_COLLABORATE_ANTENNA_PATCH_H_
...
/// @class AntennaPatch
/// @brief An approximation of a patch antenna
/// @image html raster/patch.png width=350
/// @image latex vector/patch.pdf width=0.5\textwidth
/// @details
/// \f[ g = g_{max}\cos{\theta}~~~(decibels),~~~~~0<\theta\le\pi/2 \f]
class AntennaPatch : public Antenna {
 public:
  /// @brief Constructor
  ...
  AntennaPatch(const double& _max_gain_db,
...
#endif  // LIBS_COLLABORATE_INCLUDE_COLLABORATE_ANTENNA_PATCH_H_
