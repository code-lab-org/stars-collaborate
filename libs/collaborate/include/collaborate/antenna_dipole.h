...
#ifndef LIBS_COLLABORATE_INCLUDE_COLLABORATE_ANTENNA_DIPOLE_H_
#define LIBS_COLLABORATE_INCLUDE_COLLABORATE_ANTENNA_DIPOLE_H_
...
/// @class AntennaDipole
/// @brief An approximation of a dipole antenna
/// @image html raster/dipole.png width=350
/// @image latex vector/dipole.pdf width=0.5\textwidth
/// @details
/// \f[ g = g_{max}\sin^2{\theta}~~~(decibels) \f]
class AntennaDipole : public Antenna {
 public:
  /// @brief Constructor
  /// @param[in] _max_gain_db The maximum gain (decibels)
  ...
  AntennaDipole(const double& _max_gain_db,
...
#endif  // LIBS_COLLABORATE_INCLUDE_COLLABORATE_ANTENNA_DIPOLE_H_
