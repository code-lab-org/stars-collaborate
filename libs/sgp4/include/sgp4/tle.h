...
#ifndef LIBS_SGP4_INCLUDE_SGP4_TLE_H_
#define LIBS_SGP4_INCLUDE_SGP4_TLE_H_

#include <string>

#include "sgp4/date_time.h"
#include "sgp4/tle_exception.h"
#include "sgp4/util.h"
...
class Tle {
 ...
 private:
  ...
  void ExtractDouble(const std::string& str, const int& point_pos, double* val);
...
#endif  // LIBS_SGP4_INCLUDE_SGP4_TLE_H_
